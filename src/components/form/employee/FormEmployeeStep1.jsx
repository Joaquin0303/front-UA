    ...
    return (
        <div className="form-field-container">
            ...
            {action == TABLE_ACTIONS.ADD && <>
                ...
                <InputPositionCode validation={validation} name="codigoPuesto" value={formData["codigoPuesto"]} updateFormData={updateFormData} directionCode={formData['codigoDireccion']} countryCode={formData['codigoPais']} currentPositionId={formData['id']} />
