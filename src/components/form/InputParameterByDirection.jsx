...
const InputParameterByDirection = ({ validation, name, value, valueName, parameterList, disabled, updateFormData, direction }) => {

    const fieldDescription = valueName ? valueName : "descripcion";

    const parameterListByCountry = !direction ? parameterList : parameterList.filter(p => p.texto1 == direction.codigo);
...
export default InputParameterByDirection;