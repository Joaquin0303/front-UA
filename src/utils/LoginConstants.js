...
export const LOGIN_MESSAGES = {
    ...
    ACCESS_DENIED: "Acceso denegado. El usuario no tiene permisos para acceder al reporte",
    EXPIRE_PASSWORD: "Acceso denegado. El usuario no tiene permisos para acceder al reporte",
    REPITED_NUMERO_LEGAJO: "El numero de legajo fue asignado a otro empleado"
}